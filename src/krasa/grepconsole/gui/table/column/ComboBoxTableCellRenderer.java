...
public class ComboBoxTableCellRenderer extends JPanel implements TableCellRenderer {
	...
	public JComponent getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		fillValues(table, value, row, column);

		return this;
	}

	protected void fillValues(JTable table, Object value, int row, int column) {
	...
	@SuppressWarnings("unchecked")
	protected void updateCombobox(@NotNull Iterable<?> options, @Nullable Object selectedOption) {
		myCombo.removeAllItems();
