...
public class CheckboxTreeTable extends TreeTableView {
	...
	// todo[nik] I hate to copy-paste but have to copy the code below from CheckboxTreeBase to support CheckboxTree
	// inside TreeTable in IDEA 11.1.x branch
	// todo[nik] I solemnly swear to get rid of this code in IDEA 12 branch
	private void initTree(final TreeTableTree tree, final CheckboxTreeCellRendererBase cellRenderer) {
