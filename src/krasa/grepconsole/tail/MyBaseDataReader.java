 ...
 */
public abstract class MyBaseDataReader {
  private static final Logger LOG = Logger.getInstance(MyBaseDataReader.class);
  ...
  public MyBaseDataReader(SleepingPolicy sleepingPolicy) {
