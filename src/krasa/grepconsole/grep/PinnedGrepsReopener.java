...
public class PinnedGrepsReopener {
	...
	public static boolean shouldProcess(ConsoleView console) {
		Boolean processed = PinnedGrepsReopener.processed.get(console);
		if (processed == null || !processed) {
			PinnedGrepsReopener.processed.put(console, true);
			return true;
		}
